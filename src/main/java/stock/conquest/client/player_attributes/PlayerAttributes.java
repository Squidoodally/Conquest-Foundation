...
public abstract class PlayerAttributes implements AutoSyncedComponent {
    ...
    public static final String RANGED_DEFENSE_KEY = "Ranged Defense";
    ...
    public static final String SLASH_DAMAGE_KEY = "Slash Damage";
    public static final String STRIKE_DAMAGE_KEY = "Strike Damage";
    public static final String PIERCE_DAMAGE_KEY = "Pierce Damage";
    public static final String RANGED_DAMAGE_KEY = "Ranged Damage";
    public static final String MAGICAL_DAMAGE_KEY = "Magical Damage";
    public static final String FIRE_DAMAGE_KEY = "Fire Damage";
    public static final String FROST_DAMAGE_KEY = "Frost Damage";
    public static final String SHOCK_DAMAGE_KEY = "Shock Damage";
    public static final String POISON_DAMAGE_KEY = "Poison Damage";
    ...
    public PlayerAttributes(PlayerEntity player) {
        ...
        attributes.put(MAX_STAMINA_KEY, 20.0f);
        attributes.put(CURRENT_STAMINA_KEY, 20.0f);
        ...
        attributes.put(RANGED_DEFENSE_KEY, 0.0f);
        ...
        attributes.put(SLASH_DAMAGE_KEY, 1.0f);
        attributes.put(STRIKE_DAMAGE_KEY, 1.0f);
        attributes.put(PIERCE_DAMAGE_KEY, 1.0f);
        attributes.put(RANGED_DAMAGE_KEY, 1.0f);
        attributes.put(MAGICAL_DAMAGE_KEY, 1.0f);
        attributes.put(FIRE_DAMAGE_KEY, 1.0f);
        attributes.put(FROST_DAMAGE_KEY, 1.0f);
        attributes.put(SHOCK_DAMAGE_KEY, 1.0f);
        attributes.put(POISON_DAMAGE_KEY, 1.0f);
