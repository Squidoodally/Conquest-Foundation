...
public class AttributeScoreboard {
    ...
    public static final String RANGED_DEFENSE = "ranged_defense";
    ...
    public static final String SLASH_DAMAGE = "slash_damage";
    public static final String STRIKE_DAMAGE = "strike_damage";
    ...
    public static final String FROST_DAMAGE = "frost_damage";
    public static final String SHOCK_DAMAGE = "shock_damage";
    public static final String POISON_DAMAGE = "poison_damage";
    ...
    public static void registerObjectivesForPlayer(ServerPlayerEntity player) {
        ...
        createObjectiveIfAbsent(scoreboard, RANGED_DEFENSE, Text.literal("Ranged Defense"));
        ...
        createObjectiveIfAbsent(scoreboard, SLASH_DAMAGE, Text.literal("Slash Damage"));
        createObjectiveIfAbsent(scoreboard, STRIKE_DAMAGE, Text.literal("Strike Damage"));
        createObjectiveIfAbsent(scoreboard, PIERCE_DAMAGE, Text.literal("Pierce Damage"));
        createObjectiveIfAbsent(scoreboard, RANGED_DAMAGE, Text.literal("Ranged Damage"));
        createObjectiveIfAbsent(scoreboard, MAGICAL_DAMAGE, Text.literal("Magical Damage"));
        createObjectiveIfAbsent(scoreboard, FIRE_DAMAGE, Text.literal("Fire Damage"));
        createObjectiveIfAbsent(scoreboard, FROST_DAMAGE, Text.literal("Frost Damage"));
        createObjectiveIfAbsent(scoreboard, SHOCK_DAMAGE, Text.literal("Shock Damage"));
        createObjectiveIfAbsent(scoreboard, POISON_DAMAGE, Text.literal("Poison Damage"));
